...
class CrimeSevrvice:
    def __init__(self):
        self.crime = pd.read_csv('../../../static/data/dam/crime/crime_in_seoul.csv')
        cols = ['절도 발생', '절도 검거', '폭력 발생', '폭력 검거']
        self.crime[cols] = self.crime[cols].replace(',', '', regex=True).astype(int)
        self.cctv = pd.read_csv('../../../static/data/dam/crime/cctv_in_seoul.csv')
        self.pop = pd.read_excel('../../../static/data/dam/crime/pop_in_seoul.xls', skiprows=[0, 2],
        ...
        self.polic_pos = pd.read_pickle('../../../static/save/dam/crime/police-pos.pkl')
        self.us_states = '../../../static/data/dam/crime/us-states.json'
        self.us_unemployment = pd.read_csv('../../../static/data/dam/crime/us_unemployment.csv')
        self.kr_states = '../../../static/data/dam/crime/kr-state.json'
    ...
    def save_cctv_pop(self):  # ratio
        ...
        외국인비율 과 CCTV 상관계수 [[ 1.         -0.13607433] 거의 무시될 수 있는
                                    [-0.13607433  1.        ]]                        
        """
        cctv_pop.to_pickle('../../../static/save/dam/crime/cctv_pop.pkl')
        print('--- 저장 완료 ---')
        print(pd.read_pickle('../../../static/save/dam/crime/cctv_pop.pkl'))
    ...
    def save_police_norm(self):
        ...
        police_norm.to_pickle('../../../static/save/dam/crime/police_norm.pkl')
        print(pd.read_pickle('../../../static/save/dam/crime/police_norm.pkl'))
    ...
    def folium_example(self):
        ...
        map.save('../../../static/save/dam/crime/Unemployment.html')

    def get_json_from_df(self):
        fname = '../../../static/data/dam/crime/us-states.json'
    ...
    def save_seoul_folium(self):
        ...
        map.save('../../../static/save/dam/crime/seoul_folium.html')
    ...
    def save_seoul_crime_map(self):  # 6
        ...
        mc.zoom_start = 12
        mc.save_path = "../../../static/save/dam/crime/seoul_crime_rate.html"
        MyChoroplethService(mc)

    def creat_folium_data(self):
        police_norm = pd.read_pickle('../../../static/save/dam/crime/police_norm.pkl')
